...
TextureAssets::TextureAssets()
{
	...
	smallEnemyShipExplosion.loadFromFile("Media/animations/BlueExplosion.png");
	smallEnemyShipExplosion.setSmooth(true);

	playerLifeBarHud.loadFromFile("Media/spaceships/PlayerSpaceShip/playerHud.png");
	playerLifeBarHud.setSmooth(true);

	hudBar.loadFromFile("Media/spaceships/PlayerSpaceShip/Hudbar.png");
	hudBar.setSmooth(true);

	powerUpHudBlock.loadFromFile("Media/spaceships/PlayerSpaceShip/PowerUpHudBlock.png");
	powerUpHudBlock.setSmooth(true);
...
{
	return smallEnemyShipExplosion;
}
...
sf::Texture& TextureAssets::getPlayerLifeBarHud()
{
	return playerLifeBarHud;
}

sf::Texture& TextureAssets::getHudBar()
{
	return hudBar;
}

sf::Texture& TextureAssets::getPowerUpHudBlock()
{
	return powerUpHudBlock;
}
...
void TextureAssets::fillSpaceShipTextures()
{
	...
	sf::Texture dashRightTextureNormal;
	dashRightTextureNormal.loadFromFile("Media/spaceships/PlayerSpaceShip/spaceship-dash-right.png");
	dashRightTextureNormal.setSmooth(true);

	sf::Texture dashLeftTextureNormal;
	dashLeftTextureNormal.loadFromFile("Media/spaceships/PlayerSpaceShip/spaceship-dash-left.png");
	dashLeftTextureNormal.setSmooth(true);

	sf::Texture dashLeftTextureShielded;
	dashLeftTextureShielded.loadFromFile("Media/spaceships/PlayerSpaceShip/spaceship-dash-left-ghost.png");
	dashLeftTextureShielded.setSmooth(true);

	sf::Texture dashRightTextureShielded;
	dashRightTextureShielded.loadFromFile("Media/spaceships/PlayerSpaceShip/spaceship-dash-right-sheet-ghost.png");
	dashRightTextureShielded.setSmooth(true);
	...
	spaceShipTexturesContainer.push_back(dashRightTextureNormal);
	spaceShipTexturesContainer.push_back(dashLeftTextureNormal);
	spaceShipTexturesContainer.push_back(dashLeftTextureShielded);
	spaceShipTexturesContainer.push_back(dashRightTextureShielded);
}
